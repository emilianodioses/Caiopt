 ...
 * ReciboComprobante
 *
 * @ORM\Table(name="recibo_comprobante")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ReciboComprobanteRepository")
 */
class ReciboComprobante
{
    /**
     * @var int
     *
