 ...
 * AnteojoSol
 *
 * @ORM\Table(name="anteojo_sol")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\AnteojoSolRepository")
 */
class AnteojoSol
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="color_lente", type="string", length=255)
     */
    private $colorLente;
     ...
     * Set colorLente
     *
     * @param string $colorLente
     *
     * @return AnteojoSol
     */
    public function setColorLente($colorLente)
    {
     ...
     * @return string
     */
    public function getColorLente()
    {
        return $this->colorLente;
    }
