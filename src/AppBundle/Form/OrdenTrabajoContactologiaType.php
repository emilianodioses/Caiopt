    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('cliente', EntityType::class, array(
                ...
                ->add('saldo',FloatType::class, array(
                    ...
                    'label' => 'Saldo'))
                ->add('rcOjoDerechoHorizontal',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('rcOjoIzquierdoHorizontal',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('rcOjoDerechoVertical',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('rcOjoIzquierdoVertical',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('ojoDerechoCurvas',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('ojoIzquierdoCurvas',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('ojoIzquierdoDiametro',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('ojoDerechoDiametro',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('ojoDerechoAV',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
                ...
                ->add('ojoIzquierdoAV',IntegerType::class, array(
                    'attr' => array(
                    'required' => true,
                    'empty_data' => 0,
                    'step' => 0.1,
